...
/* 
 * This file is added only to address the issue identified here
 * https://github.com/gruntjs/grunt-lib-phantomjs/pull/49
 * once that issue is merged and updated grunt-lib-phantomjs is released
 * this and the Gruntfile.js option to use it should be depricated 
 */
